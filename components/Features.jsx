...
const Features = () => {
  return (
    <div className="w-full bg-black px-6 py-16">
      <h2 className="text-center text-white font-bold text-5xl sm:text-6xl tracking-tight mb-16">
        Everything You Need to Manage Your Health
      </h2>

      <ul className="mx-20 grid grid-cols-1 gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2 justify-center items-center">
        <GridItem
